...
class FluxService implements SingletonInterface
{
    ...
    public function getAllTypoScript()
    {
        if (!$this->configurationManager instanceof BackendConfigurationManager) {
            if (false === isset(self::$typoScript[ConfigurationManagerInterface::CONFIGURATION_TYPE_FULL_TYPOSCRIPT])) {
                ...
                self::$typoScript[ConfigurationManagerInterface::CONFIGURATION_TYPE_FULL_TYPOSCRIPT] = $typoScript;
            }
            return self::$typoScript[ConfigurationManagerInterface::CONFIGURATION_TYPE_FULL_TYPOSCRIPT];
        } else {
    ...
    public function message($message, $severity = GeneralUtility::SYSLOG_SEVERITY_INFO, $title = 'Flux Debug')
    {
        ...
        $isExcludedSeverity = (true === $shouldExcludedFriendlySeverities && true === in_array(
                $severity,
                self::$friendlySeverities
            ));
